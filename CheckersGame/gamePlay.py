...
def isCapturePossibleFromPosition(board, x, y):
	...
	if canMoveToPosition(board, x, y, x-2, y-2) == True:#top left diagonal leaving 1
		return True	
	if canMoveToPosition(board, x, y, x-2, y+2) == True:#bottom left
		return True	
	if canMoveToPosition(board, x, y, x+2, y-2) == True:#right top
		return True	
	if canMoveToPosition(board, x, y, x+2, y+2) == True:#right bottom
		return True	
